...
// Retrieve form data
$name = isset($_POST['a1']) ? $_POST['a1'] : '';
$email = isset($_POST['a2']) ? $_POST['a2'] : '';
$ser = isset($_POST['a3']) ? $_POST['a3'] : '';
$mes = isset($_POST['a4']) ? $_POST['a4'] : '';

// Use prepared statement to prevent SQL injection
$stmt = $conn->prepare("INSERT INTO rec (name, email, ser, mes, date) VALUES (?, ?, ?, ?, DATE_FORMAT(NOW(), '%Y-%m-%d %H:%i:%s'))");
$stmt->bind_param("ssss", $name, $email, $ser, $mes);
